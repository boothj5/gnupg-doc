...
** [[http://www.profanity.im/][Profanity]] [Unix,Windows,OSX] CHAT
   :PROPERTIES:
   :CUSTOM_ID: profanity
   :END:

Profanity is a console based XMPP client, which runs on Linux, OSX 
and Windows (using Cygwin). It is released under the GNU General 
Public License.
